...
class CircleComponent extends React.Component {
    ...
    hasText = true
    componentDidMount() {
        let { width, height, lineWidth, hasText } = this.props
    ...
    drawOutCircle(timestamp) {
        ...
        // linearGradient.addColorStop(
        //     0.6,
        //     `rgba(109,29,152,${(this.props.value -
        //         (this.props.value - this.endValue)) /
        //         this.props.value})`
        // )
        // linearGradient.addColorStop(
        //     0.9,
        //     `rgba(204,24,93,${(this.props.value -
        //         (this.props.value - this.endValue)) /
        //         this.props.value})`
        // )
        linearGradient.addColorStop(
    ...
    drawInCircle() {
        ...
        this.ctx.shadowColor = 'rgba(0,4,104,0.22)'
        //设置笔触的颜色
    ...
    drawText() {
        this.ctx.font = `bold ${((this.endValue === 100 ? 20 : 24) *
            this.width) /
            100}px Arial`
        this.ctx.fillStyle = '#fff'
        this.ctx.textBaseline = 'middle'
